          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <table className="table">
                ...
                <tbody>
                  {schedule.subjects[index]?.attendance.map(
                    (subject, index) => {
                      return (
                        <tr>
          ...
          <div>
            ...
            >
              ...
              {classes.map((classs, index) => {
                return (
                  <option value={classs.degree + classs.year + classs.section}>
                    {classs.degree + classs.year + classs.section}
                  </option>
                );
              })}
            </select>
              ...
              {schedule.subjects.map((subject, i) => {
                return (
                  <tr className="table-data">
                    ...
                    <td>{subject.slot}</td>
                    <td>{subject.room}</td>
                    <td data-toggle="modal" data-target="#attendance">
                      <i
                        onClick={() => setIndex(i)}
                        className="fas fa-clipboard-list mt-2"
                      ></i>
                    </td>
                  </tr>
                );
